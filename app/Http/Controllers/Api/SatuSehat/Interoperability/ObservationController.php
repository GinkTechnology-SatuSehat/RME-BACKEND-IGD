...
class ObservationController extends Controller
{
    ...
    public function add_bodySite($data_observation)
    {
        if (isset($data_observation['bodySite'])) {
            $this->observation['bodySite'] = [
                'coding' => [
                    [
                        'system' => $data_observation['bodySite']['system'],
    ...
    public function add_interpretation($data_observation)
    {
        if (isset($data_observation['interpretation'])) {
            $this->observation['interpretation'][] = [
                'coding' => [
                    [
                        "system" => $data_observation['interpretation'][0]['system'],
    ...
    public function add_valueBoolean($data_observation)
    {
        if (isset($data_observation['valueBoolean'])) {
            $this->observation['valueBoolean'] = $data_observation['valueBoolean'];
        }
    }

    public function add_valueInteger($data_observation)
    {
        if (isset($data_observation['valueInteger'])) {
            $this->observation['valueInteger'] = $data_observation['valueInteger'];
        }
    }
    ...
    public function json($data_observation)
    {
        ...
        $this->add_valueBoolean($data_observation);
        $this->add_valueInteger($data_observation);
