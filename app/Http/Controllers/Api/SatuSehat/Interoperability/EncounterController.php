...
class EncounterController extends Controller
{
    ...
    public function add_classHistory($data_encounter)
    {
        if (isset($data_encounter['classHistory'])) {
            for ($i = 0; $i < count($data_encounter['classHistory']); $i++) {
                if (isset($data_encounter['classHistory'][$i]['class'])) {
                    $this->encounter['classHistory'][$i]['class'] = [
                        'system' => $data_encounter['classHistory'][$i]['class']['system'],
                        'code' => $data_encounter['classHistory'][$i]['class']['code'],
                    ];

                    if (isset($data_encounter['classHistory'][$i]['class']['display'])) {
                        $this->encounter['classHistory'][$i]['class']['display'] = $data_encounter['classHistory'][$i]['class']['display'];
                    }
                }

                if (isset($data_encounter['classHistory'][$i]['period'])) {
                    $this->encounter['classHistory'][$i]['period'] = [
                        'start' => $data_encounter['classHistory'][$i]['period']['start'],
                    ];

                    if (isset($data_encounter['classHistory'][$i]['period']['end'])) {
                        $this->encounter['classHistory'][$i]['period']['end'] = $data_encounter['classHistory'][$i]['period']['end'];
                    }
                }
            }
        }
    ...
    public function json($data_encounter)
    {
        ...
        $this->add_classHistory($data_encounter);
