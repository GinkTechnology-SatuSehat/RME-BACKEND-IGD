...
class EncounterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'classHistory' => 'array',
            'classHistory.*.class' => ['array'],
            'classHistory.*.class.system' => $this->filled('classHistory.*.class') ? ['required', 'string'] : '',
            'classHistory.*.class.code' => $this->filled('classHistory.*.class') ? ['required', 'string'] : '',
            'classHistory.*.class.display' => ['string'],
            'classHistory.*.period' => ['array'],
            'classHistory.*.period.start' => $this->filled('classHistory.*.period') ? ['required', 'date'] : '',
            'classHistory.*.period.end' => ['date']
        ];
    }
